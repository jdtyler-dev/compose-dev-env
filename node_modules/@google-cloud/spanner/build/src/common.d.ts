...
export declare type Schema = string | string[] | databaseAdmin.spanner.admin.database.v1.IUpdateDatabaseDdlRequest;
...
export declare type PagedResponse<Item, Response> = [Item[], {} | null, Response];

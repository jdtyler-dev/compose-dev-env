...
export declare type CommitRequest = spannerClient.spanner.v1.ICommitRequest;
export declare type BatchUpdateResponse = [number[], spannerClient.spanner.v1.ExecuteBatchDmlResponse];
export declare type BeginResponse = [spannerClient.spanner.v1.ITransaction];
export declare type BeginTransactionCallback = NormalCallback<spannerClient.spanner.v1.ITransaction>;
export declare type CommitResponse = [spannerClient.spanner.v1.ICommitResponse];
export declare type ReadResponse = [Rows];
export declare type RunResponse = [Rows, spannerClient.spanner.v1.ResultSetStats, spannerClient.spanner.v1.ResultSetMetadata];
...
export declare type ReadCallback = NormalCallback<Rows>;
...
export declare type CommitCallback = NormalCallback<spannerClient.spanner.v1.ICommitResponse>;
/**

 ...
 */
import { GoogleAuthOptions, Operation, Service, Metadata } from '@google-cloud/common';
import { Project } from './project';
export declare type CreateProjectCallback = (err: Error | null, project?: Project | null, operation?: Operation<Project>, apiResponse?: Metadata) => void;
export declare type CreateProjectResponse = [Project, Operation<Project>, Metadata];
export declare type GetProjectsResponse = [Project[], Metadata];
export declare type GetProjectsCallback = (err: Error | null, projects?: Project[] | null, nextQuery?: {} | null, apiResponse?: Metadata) => void;
 ...
 */
declare class Resource extends Service {
     ...
     *   });
     */
    createProject(id: string, options?: CreateProjectOptions): Promise<CreateProjectResponse>;
    createProject(id: string, options: CreateProjectOptions, callback: CreateProjectCallback): void;
     ...
     */
    operation(name: string): Operation<Project>;
    /**

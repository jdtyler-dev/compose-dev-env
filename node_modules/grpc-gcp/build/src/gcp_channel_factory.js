...
function getGcpChannelFactoryClass(grpc) {
    /**
     * A channel management factory that implements grpc.Channel APIs.
     */
    return class GcpChannelFactory {
        /**
        ...
        watchConnectivityState(currentState, deadline, callback) {
            ...
            const watchState = (channelRef) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield util_1.promisify(channel.watchConnectivityState).call(channel, startingState, deadline);
